...
["Autohide Energy ticker"] = "Autohide Energy ticker",
["Hide the energy ticker when it's not needed"] = "Hide the energy ticker when it's not needed",
["Totem bar"] = "Totem bar",
...
["Show solo"] = "Show solo",
["Show raid frame when solo"] = "Show raid frame when solo",
["Vertical"] = "Vertical",
