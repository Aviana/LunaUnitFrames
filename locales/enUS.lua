...
["LunaUF: Entering config mode."] = "LunaUF: Entering config mode.",
["LunaUF: Exiting config mode."] = "LunaUF: Exiting config mode.",
["menu"] = "menu",
...
["Your (.+) %a%a?its (.+) for %d+\."] = "Your (.+) %a%a?its (.+) for %d+\.",
["%a+'s (.+) %a%a?its (.+) for %d+\."] = "%a+'s (.+) %a%a?its (.+) for %d+\.",
