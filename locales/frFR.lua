...
["Position"] = "Position",
["CHAT_MSG_COMBAT_HITS"] = "(%a+) c?[rh]its .+",
["CHAT_MSG_COMBAT_CREATURE_VS_HITS"] = ".+ c?[rh]its (%a+) for .+",
["CHAT_MSG_SPELL_CREATURE_VS_DAMAGE1"] = ".+'s .+ c?[rh]its (%a+) for .+",
["CHAT_MSG_SPELL_CREATURE_VS_DAMAGE2"] = ".+'s .+ was resisted by (%a+)%.",
