...
function LunaOptionsModule:CreateMenu()
	...
	LunaOptionsFrame.pages[1].bufftimer:SetPoint("TOPRIGHT", LunaOptionsFrame.pages[1].XPBar, "TOPRIGHT", 0, -20)
	...
	cccpopup.page.ctrlleft:SetText(LunaOptions.clickcast[playerName][5][1] or "")
	...
	cccpopup.page.ctrlleft:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][5][1] = this:GetText() end)
	...
	cccpopup.page.ctrlright:SetText(LunaOptions.clickcast[playerName][5][2] or "")
	...
	cccpopup.page.ctrlright:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][5][2] = this:GetText() end)
	...
	cccpopup.page.ctrlmiddle:SetText(LunaOptions.clickcast[playerName][5][3] or "")
	...
	cccpopup.page.ctrlmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][5][3] = this:GetText() end)
	...
	cccpopup.page.ctrlfour:SetText(LunaOptions.clickcast[playerName][5][4] or "")
	...
	cccpopup.page.ctrlfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][5][4] = this:GetText() end)
	...
	cccpopup.page.ctrlfive:SetText(LunaOptions.clickcast[playerName][5][5] or "")
	...
	cccpopup.page.ctrlfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][5][5] = this:GetText() end)
	
	cccpopup.page.shiftalttext = cccpopup.page:CreateFontString(nil, "OVERLAY", cccpopup.page)
	cccpopup.page.shiftalttext:SetPoint("CENTER", cccpopup.page.ctrltext, "CENTER", 135, 0)
	cccpopup.page.shiftalttext:SetFont("Fonts\\FRIZQT__.TTF", 10)
	cccpopup.page.shiftalttext:SetTextColor(1,0.82,0)
	cccpopup.page.shiftalttext:SetText("SHIFT+ALT")
	
	cccpopup.page.shiftaltleft = CreateFrame("Editbox", "leftshiftaltEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftaltleft:SetHeight(20)
	cccpopup.page.shiftaltleft:SetWidth(120)
	cccpopup.page.shiftaltleft:SetAutoFocus(nil)
	cccpopup.page.shiftaltleft:SetPoint("TOP", cccpopup.page.shiftalttext, "BOTTOM", 0, -10)
	cccpopup.page.shiftaltleft:SetText(LunaOptions.clickcast[playerName][4][1] or "")
	cccpopup.page.shiftaltleft:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftaltleft:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftaltleft:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][4][1] = this:GetText() end)
																	
	cccpopup.page.shiftaltright = CreateFrame("Editbox", "rightshiftaltEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftaltright:SetHeight(20)
	cccpopup.page.shiftaltright:SetWidth(120)
	cccpopup.page.shiftaltright:SetAutoFocus(nil)
	cccpopup.page.shiftaltright:SetPoint("TOP", cccpopup.page.shiftaltleft, "BOTTOM", 0, -10)
	cccpopup.page.shiftaltright:SetText(LunaOptions.clickcast[playerName][4][2] or "")
	cccpopup.page.shiftaltright:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftaltright:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftaltright:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][4][2] = this:GetText() end)
	
	cccpopup.page.shiftaltmiddle = CreateFrame("Editbox", "middleshiftaltEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftaltmiddle:SetHeight(20)
	cccpopup.page.shiftaltmiddle:SetWidth(120)
	cccpopup.page.shiftaltmiddle:SetAutoFocus(nil)
	cccpopup.page.shiftaltmiddle:SetPoint("TOP", cccpopup.page.shiftaltright, "BOTTOM", 0, -10)
	cccpopup.page.shiftaltmiddle:SetText(LunaOptions.clickcast[playerName][4][3] or "")
	cccpopup.page.shiftaltmiddle:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftaltmiddle:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftaltmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][4][3] = this:GetText() end)
	
	cccpopup.page.shiftaltfour = CreateFrame("Editbox", "fourshiftaltEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftaltfour:SetHeight(20)
	cccpopup.page.shiftaltfour:SetWidth(120)
	cccpopup.page.shiftaltfour:SetAutoFocus(nil)
	cccpopup.page.shiftaltfour:SetPoint("TOP", cccpopup.page.shiftaltmiddle, "BOTTOM", 0, -10)
	cccpopup.page.shiftaltfour:SetText(LunaOptions.clickcast[playerName][4][4] or "")
	cccpopup.page.shiftaltfour:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftaltfour:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftaltfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][4][4] = this:GetText() end)
	
	cccpopup.page.shiftaltfive = CreateFrame("Editbox", "fiveshiftaltEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftaltfive:SetHeight(20)
	cccpopup.page.shiftaltfive:SetWidth(120)
	cccpopup.page.shiftaltfive:SetAutoFocus(nil)
	cccpopup.page.shiftaltfive:SetPoint("TOP", cccpopup.page.shiftaltfour, "BOTTOM", 0, -10)
	cccpopup.page.shiftaltfive:SetText(LunaOptions.clickcast[playerName][4][5] or "")
	cccpopup.page.shiftaltfive:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftaltfive:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftaltfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][4][5] = this:GetText() end)
	
	cccpopup.page.shiftctrltext = cccpopup.page:CreateFontString(nil, "OVERLAY", cccpopup.page)
	cccpopup.page.shiftctrltext:SetPoint("CENTER", cccpopup.page.shiftalttext, "CENTER", 135, 0)
	cccpopup.page.shiftctrltext:SetFont("Fonts\\FRIZQT__.TTF", 10)
	cccpopup.page.shiftctrltext:SetTextColor(1,0.82,0)
	cccpopup.page.shiftctrltext:SetText("SHIFT+CTRL")
	
	cccpopup.page.shiftctrlleft = CreateFrame("Editbox", "leftshiftctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftctrlleft:SetHeight(20)
	cccpopup.page.shiftctrlleft:SetWidth(120)
	cccpopup.page.shiftctrlleft:SetAutoFocus(nil)
	cccpopup.page.shiftctrlleft:SetPoint("TOP", cccpopup.page.shiftctrltext, "BOTTOM", 0, -10)
	cccpopup.page.shiftctrlleft:SetText(LunaOptions.clickcast[playerName][6][1] or "")
	cccpopup.page.shiftctrlleft:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftctrlleft:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftctrlleft:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][6][1] = this:GetText() end)
																	
	cccpopup.page.shiftctrlright = CreateFrame("Editbox", "rightshiftctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftctrlright:SetHeight(20)
	cccpopup.page.shiftctrlright:SetWidth(120)
	cccpopup.page.shiftctrlright:SetAutoFocus(nil)
	cccpopup.page.shiftctrlright:SetPoint("TOP", cccpopup.page.shiftctrlleft, "BOTTOM", 0, -10)
	cccpopup.page.shiftctrlright:SetText(LunaOptions.clickcast[playerName][6][2] or "")
	cccpopup.page.shiftctrlright:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftctrlright:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftctrlright:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][6][2] = this:GetText() end)
	
	cccpopup.page.shiftctrlmiddle = CreateFrame("Editbox", "middleshiftctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftctrlmiddle:SetHeight(20)
	cccpopup.page.shiftctrlmiddle:SetWidth(120)
	cccpopup.page.shiftctrlmiddle:SetAutoFocus(nil)
	cccpopup.page.shiftctrlmiddle:SetPoint("TOP", cccpopup.page.shiftctrlright, "BOTTOM", 0, -10)
	cccpopup.page.shiftctrlmiddle:SetText(LunaOptions.clickcast[playerName][6][3] or "")
	cccpopup.page.shiftctrlmiddle:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftctrlmiddle:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftctrlmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][6][3] = this:GetText() end)
	
	cccpopup.page.shiftctrlfour = CreateFrame("Editbox", "fourshiftctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftctrlfour:SetHeight(20)
	cccpopup.page.shiftctrlfour:SetWidth(120)
	cccpopup.page.shiftctrlfour:SetAutoFocus(nil)
	cccpopup.page.shiftctrlfour:SetPoint("TOP", cccpopup.page.shiftctrlmiddle, "BOTTOM", 0, -10)
	cccpopup.page.shiftctrlfour:SetText(LunaOptions.clickcast[playerName][6][4] or "")
	cccpopup.page.shiftctrlfour:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftctrlfour:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftctrlfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][6][4] = this:GetText() end)
	
	cccpopup.page.shiftctrlfive = CreateFrame("Editbox", "fiveshiftctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.shiftctrlfive:SetHeight(20)
	cccpopup.page.shiftctrlfive:SetWidth(120)
	cccpopup.page.shiftctrlfive:SetAutoFocus(nil)
	cccpopup.page.shiftctrlfive:SetPoint("TOP", cccpopup.page.shiftctrlfour, "BOTTOM", 0, -10)
	cccpopup.page.shiftctrlfive:SetText(LunaOptions.clickcast[playerName][6][5] or "")
	cccpopup.page.shiftctrlfive:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.shiftctrlfive:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.shiftctrlfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][6][5] = this:GetText() end)
	
	cccpopup.page.altctrltext = cccpopup.page:CreateFontString(nil, "OVERLAY", cccpopup.page)
	cccpopup.page.altctrltext:SetPoint("CENTER", cccpopup.page.shiftctrltext, "CENTER", 135, 0)
	cccpopup.page.altctrltext:SetFont("Fonts\\FRIZQT__.TTF", 10)
	cccpopup.page.altctrltext:SetTextColor(1,0.82,0)
	cccpopup.page.altctrltext:SetText("ALT+CTRL")
	
	cccpopup.page.altctrlleft = CreateFrame("Editbox", "leftaltctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.altctrlleft:SetHeight(20)
	cccpopup.page.altctrlleft:SetWidth(120)
	cccpopup.page.altctrlleft:SetAutoFocus(nil)
	cccpopup.page.altctrlleft:SetPoint("TOP", cccpopup.page.altctrltext, "BOTTOM", 0, -10)
	cccpopup.page.altctrlleft:SetText(LunaOptions.clickcast[playerName][7][1] or "")
	cccpopup.page.altctrlleft:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.altctrlleft:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.altctrlleft:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][7][1] = this:GetText() end)
																	
	cccpopup.page.altctrlright = CreateFrame("Editbox", "rightaltctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.altctrlright:SetHeight(20)
	cccpopup.page.altctrlright:SetWidth(120)
	cccpopup.page.altctrlright:SetAutoFocus(nil)
	cccpopup.page.altctrlright:SetPoint("TOP", cccpopup.page.altctrlleft, "BOTTOM", 0, -10)
	cccpopup.page.altctrlright:SetText(LunaOptions.clickcast[playerName][7][2] or "")
	cccpopup.page.altctrlright:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.altctrlright:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.altctrlright:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][7][2] = this:GetText() end)
	
	cccpopup.page.altctrlmiddle = CreateFrame("Editbox", "middlealtctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.altctrlmiddle:SetHeight(20)
	cccpopup.page.altctrlmiddle:SetWidth(120)
	cccpopup.page.altctrlmiddle:SetAutoFocus(nil)
	cccpopup.page.altctrlmiddle:SetPoint("TOP", cccpopup.page.altctrlright, "BOTTOM", 0, -10)
	cccpopup.page.altctrlmiddle:SetText(LunaOptions.clickcast[playerName][7][3] or "")
	cccpopup.page.altctrlmiddle:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.altctrlmiddle:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.altctrlmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][7][3] = this:GetText() end)
	
	cccpopup.page.altctrlfour = CreateFrame("Editbox", "fouraltctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.altctrlfour:SetHeight(20)
	cccpopup.page.altctrlfour:SetWidth(120)
	cccpopup.page.altctrlfour:SetAutoFocus(nil)
	cccpopup.page.altctrlfour:SetPoint("TOP", cccpopup.page.altctrlmiddle, "BOTTOM", 0, -10)
	cccpopup.page.altctrlfour:SetText(LunaOptions.clickcast[playerName][7][4] or "")
	cccpopup.page.altctrlfour:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.altctrlfour:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.altctrlfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][7][4] = this:GetText() end)
	
	cccpopup.page.altctrlfive = CreateFrame("Editbox", "fivealtctrlEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.altctrlfive:SetHeight(20)
	cccpopup.page.altctrlfive:SetWidth(120)
	cccpopup.page.altctrlfive:SetAutoFocus(nil)
	cccpopup.page.altctrlfive:SetPoint("TOP", cccpopup.page.altctrlfour, "BOTTOM", 0, -10)
	cccpopup.page.altctrlfive:SetText(LunaOptions.clickcast[playerName][7][5] or "")
	cccpopup.page.altctrlfive:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.altctrlfive:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.altctrlfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][7][5] = this:GetText() end)
	
	cccpopup.page.allmodtext = cccpopup.page:CreateFontString(nil, "OVERLAY", cccpopup.page)
	cccpopup.page.allmodtext:SetPoint("CENTER", cccpopup.page.altctrltext, "CENTER", 135, 0)
	cccpopup.page.allmodtext:SetFont("Fonts\\FRIZQT__.TTF", 10)
	cccpopup.page.allmodtext:SetTextColor(1,0.82,0)
	cccpopup.page.allmodtext:SetText("ALL")
	
	cccpopup.page.allmodleft = CreateFrame("Editbox", "leftallmodEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.allmodleft:SetHeight(20)
	cccpopup.page.allmodleft:SetWidth(120)
	cccpopup.page.allmodleft:SetAutoFocus(nil)
	cccpopup.page.allmodleft:SetPoint("TOP", cccpopup.page.allmodtext, "BOTTOM", 0, -10)
	cccpopup.page.allmodleft:SetText(LunaOptions.clickcast[playerName][8][1] or "")
	cccpopup.page.allmodleft:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.allmodleft:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.allmodleft:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][8][1] = this:GetText() end)
																	
	cccpopup.page.allmodright = CreateFrame("Editbox", "rightallmodEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.allmodright:SetHeight(20)
	cccpopup.page.allmodright:SetWidth(120)
	cccpopup.page.allmodright:SetAutoFocus(nil)
	cccpopup.page.allmodright:SetPoint("TOP", cccpopup.page.allmodleft, "BOTTOM", 0, -10)
	cccpopup.page.allmodright:SetText(LunaOptions.clickcast[playerName][8][2] or "")
	cccpopup.page.allmodright:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.allmodright:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.allmodright:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][8][2] = this:GetText() end)
	
	cccpopup.page.allmodmiddle = CreateFrame("Editbox", "middleallmodEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.allmodmiddle:SetHeight(20)
	cccpopup.page.allmodmiddle:SetWidth(120)
	cccpopup.page.allmodmiddle:SetAutoFocus(nil)
	cccpopup.page.allmodmiddle:SetPoint("TOP", cccpopup.page.allmodright, "BOTTOM", 0, -10)
	cccpopup.page.allmodmiddle:SetText(LunaOptions.clickcast[playerName][8][3] or "")
	cccpopup.page.allmodmiddle:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.allmodmiddle:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.allmodmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][8][3] = this:GetText() end)
	
	cccpopup.page.allmodfour = CreateFrame("Editbox", "fourallmodEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.allmodfour:SetHeight(20)
	cccpopup.page.allmodfour:SetWidth(120)
	cccpopup.page.allmodfour:SetAutoFocus(nil)
	cccpopup.page.allmodfour:SetPoint("TOP", cccpopup.page.allmodmiddle, "BOTTOM", 0, -10)
	cccpopup.page.allmodfour:SetText(LunaOptions.clickcast[playerName][8][4] or "")
	cccpopup.page.allmodfour:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.allmodfour:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.allmodfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][8][4] = this:GetText() end)
	
	cccpopup.page.allmodfive = CreateFrame("Editbox", "fiveallmodEditBox", cccpopup.page, "InputBoxTemplate")
	cccpopup.page.allmodfive:SetHeight(20)
	cccpopup.page.allmodfive:SetWidth(120)
	cccpopup.page.allmodfive:SetAutoFocus(nil)
	cccpopup.page.allmodfive:SetPoint("TOP", cccpopup.page.allmodfour, "BOTTOM", 0, -10)
	cccpopup.page.allmodfive:SetText(LunaOptions.clickcast[playerName][8][5] or "")
	cccpopup.page.allmodfive:SetScript("OnEnterPressed", function() this:ClearFocus() end)
	cccpopup.page.allmodfive:SetScript("OnEditFocusGained", function() cccpopup.current = this end)
	cccpopup.page.allmodfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[playerName][8][5] = this:GetText() end)
