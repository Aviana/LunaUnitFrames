...
function LunaUF:CreateConfig()
	...
	local function getTag(info)
		local barName, opt1, opt2 = strsplit("_", info[#info])
		if opt2 then
			return LunaUF.db.profile.units[info[#info-2]].tags[barName][opt1][opt2]
		else
			return LunaUF.db.profile.units[info[#info-2]].tags[barName][opt1]
		end
	end
	...
	local function setTag(info, value)
		...
		if opt2 then
			LunaUF.db.profile.units[unit].tags[barName][opt1][opt2] = value
		else
			LunaUF.db.profile.units[unit].tags[barName][opt1] = value
		end
		...
		["auras"] = {
			...
			args = {
				...
				weaponbuffs = {
					...
					type = "toggle",
					order = 11,
					hidden = function(info) return info[#info-1] ~= "player" end
				},
				bordercolor = {
					name = L["Bordercolor"],
