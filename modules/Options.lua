...
function LunaOptionsModule:CreateMenu()
	...
	cccpopup.page.noneleft:SetText(LunaOptions.clickcast[1][1] or "target")
	...
	cccpopup.page.noneright:SetText(LunaOptions.clickcast[1][2] or "menu")
	...
	cccpopup.page.nonemiddle:SetText(LunaOptions.clickcast[1][3] or "")
	...
	cccpopup.page.nonemiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[1][3] = this:GetText() end)
	...
	cccpopup.page.none4:SetText(LunaOptions.clickcast[1][4] or "")
	...
	cccpopup.page.none4:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[1][4] = this:GetText() end)
	...
	cccpopup.page.none5:SetText(LunaOptions.clickcast[1][5] or "")
	...
	cccpopup.page.none5:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[1][5] = this:GetText() end)
	...
	cccpopup.page.shiftleft:SetText(LunaOptions.clickcast[2][1] or "")
	...
	cccpopup.page.shiftright:SetText(LunaOptions.clickcast[2][2] or "")
	...
	cccpopup.page.shiftmiddle:SetText(LunaOptions.clickcast[2][3] or "")
	...
	cccpopup.page.shiftmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[2][3] = this:GetText() end)
	...
	cccpopup.page.shiftfour:SetText(LunaOptions.clickcast[2][4] or "")
	...
	cccpopup.page.shiftfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[2][4] = this:GetText() end)
	...
	cccpopup.page.shiftfive:SetText(LunaOptions.clickcast[2][5] or "")
	...
	cccpopup.page.shiftfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[2][5] = this:GetText() end)
	...
	cccpopup.page.altleft:SetText(LunaOptions.clickcast[3][1] or "")
	...
	cccpopup.page.altright:SetText(LunaOptions.clickcast[3][2] or "")
	...
	cccpopup.page.altmiddle:SetText(LunaOptions.clickcast[3][3] or "")
	...
	cccpopup.page.altmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[3][3] = this:GetText() end)
	...
	cccpopup.page.altfour:SetText(LunaOptions.clickcast[3][4] or "")
	...
	cccpopup.page.altfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[3][4] = this:GetText() end)
	...
	cccpopup.page.altfive:SetText(LunaOptions.clickcast[3][5] or "")
	...
	cccpopup.page.altfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[3][5] = this:GetText() end)
	...
	cccpopup.page.ctrlleft:SetText(LunaOptions.clickcast[4][1] or "")
	...
	cccpopup.page.ctrlright:SetText(LunaOptions.clickcast[4][2] or "")
	...
	cccpopup.page.ctrlmiddle:SetText(LunaOptions.clickcast[4][3] or "")
	...
	cccpopup.page.ctrlmiddle:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[4][3] = this:GetText() end)
	...
	cccpopup.page.ctrlfour:SetText(LunaOptions.clickcast[4][4] or "")
	...
	cccpopup.page.ctrlfour:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[4][4] = this:GetText() end)
	...
	cccpopup.page.ctrlfive:SetText(LunaOptions.clickcast[4][5] or "")
	...
	cccpopup.page.ctrlfive:SetScript("OnEditFocusLost", function() LunaOptions.clickcast[4][5] = this:GetText() end)
