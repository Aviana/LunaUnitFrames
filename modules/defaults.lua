	...
	profile = {
		...
		units = {
			player = {
				...
				auras = { buffs = "BOTH", enabled = false, AurasPerRow = 12, position = "BOTTOM", weaponbuffs = true, timertextenabled = true, timertextbigsize = 23,timertextsmallsize = 12, timerspinenabled = true },
			...
			pet = {
				...
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = true, type = "3D", side = "left", size = 6 },
				auras = { buffs = "BOTH", enabled = false, AurasPerRow = 12, position = "BOTTOM" },
				highlight = { enabled = true, ontarget = false, ondebuff = true, onmouse = false, alpha = 0.6 },
				fader = { enabled = false, inactiveAlpha = 0.2, combatAlpha = 1, speedyFade = false },
				tags = {
					enabled = true,
			...
			pettarget = {
				...
				auras = { buffs = "BOTH", enabled = false, AurasPerRow = 8, position = "BOTTOM" },
			...
			target = {
				...
				auras = { buffs = "BOTH", enabled = true, AurasPerRow = 12, position = "BOTTOM"},
				highlight = { enabled = true, ontarget = false, ondebuff = true, onmouse = false, alpha = 0.6 },
				fader = { enabled = false, inactiveAlpha = 0.2, combatAlpha = 1, speedyFade = false },
				tags = {
					enabled = true,
			...
			party = {
				...
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = true, type = "3D", side = "left", size = 6 },
				auras = { buffs = "BOTH", enabled = true, AurasPerRow = 11, position = "BOTTOM" },
				highlight = { enabled = true, ontarget = false, ondebuff = true, onmouse = false, alpha = 0.6 },
				fader = { enabled = false, inactiveAlpha = 0.2, combatAlpha = 1, speedyFade = false },
				tags = {
					enabled = true,
			...
			raid = {
				...
				emptyBar = { enabled = false, size = 3 },
				portrait = { enabled = false, type = "3D", side = "left", size = 6 },
				auras = { buffs = "BOTH", enabled = false, AurasPerRow = 6, position = "RIGHT" },
				highlight = { enabled = true, ontarget = false, ondebuff = true, onmouse = false, alpha = 0.6 },
				fader = { enabled = false, inactiveAlpha = 0.2, combatAlpha = 1, speedyFade = false },
				tags = {
					enabled = true,
