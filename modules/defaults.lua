	...
	self.defaults.profile.units = {
		player = {
			...
			squares = {
				...
				center = {enabled = false, type = "aggro", size = 20 },
			...
			indicators = {
				...
				ready = { enabled = true, anchorPoint = "LEFT", size = 24, x = 30, y = 0 },
				status = { enabled = true, anchorPoint = "BOTTOMLEFT", size = 16, x = 30, y = 5 },
				rezz = { enabled = true, anchorPoint = "LEFT", size = 20, x = 30, y = 0 },
			},
		...
		pet = {
			...
			indicators = {
				happiness = {enabled = true, anchorPoint = "BOTTOMRIGHT", size = 14, x = -2, y = 2},
				status = { enabled = true, anchorPoint = "BOTTOMLEFT", size = 16, x = 30, y = 4},
			},
		...
		target = {
			...
			indicators = {
				...
				pvp = { enabled = true, anchorPoint = "RIGHT", size = 30, x = 1, y = -4 },
				pvprank = { enabled = true, anchorPoint = "RIGHT", size = 8, x = -46, y = -16 },
				status = { enabled = true, anchorPoint = "BOTTOMRIGHT", size = 16, x = -30, y = 5 },
		...
		maintank = {
			...
			indicators = {
				raidTarget = { enabled = true, anchorPoint = "CENTER", size = 20, x = 0, y = 0 },
				class = { enabled = false, anchorPoint = "BOTTOMLEFT", size = 16, x = 4, y = 4 },
				masterLoot = { enabled = false, anchorPoint = "TOPLEFT", size = 12, x = 16, y = -4 },
				leader = { enabled = false, anchorPoint = "TOPLEFT", size = 14, x = 4, y = -4 },
				pvp = { enabled = false, anchorPoint = "LEFT", size = 30, x = 9, y = -4 },
				pvprank = { enabled = false, anchorPoint = "LEFT", size = 8, x = 46, y = -16 },
				ready = { enabled = true, anchorPoint = "CENTER", size = 24, x = 0, y = 0 },
				status = { enabled = false, anchorPoint = "BOTTOM", size = 16, x = 0, y = 5 },
				rezz = { enabled = true, anchorPoint = "CENTER", size = 20, x = 0, y = 0 },
			},
		...
		maintanktarget = {
			...
			indicators = {
				...
				elite = { enabled = false, anchorPoint = "RIGHT" },
				class = { enabled = false, anchorPoint = "BOTTOMRIGHT", size = 16, x = -4, y = 4 },
				masterLoot = { enabled = false, anchorPoint = "TOPRIGHT", size = 12, x = -16, y = -4 },
				leader = { enabled = false, anchorPoint = "TOPRIGHT", size = 14, x = -4, y = -4 },
				pvp = { enabled = false, anchorPoint = "RIGHT", size = 30, x = 1, y = -4 },
				pvprank = { enabled = false, anchorPoint = "BOTTOMLEFT", size = 8, x = 4, y = 4 },
				status = { enabled = false, anchorPoint = "BOTTOMRIGHT", size = 16, x = -30, y = 5 },
				rezz = { enabled = false, anchorPoint = "CENTER", size = 20, x = 0, y = 0 },
			},
			incHeal = { enabled = false, cap = 1.3, alpha = 0.8 },
			scale = 1,
